...
public class Opening
{
	...
	public Opening()
	{
    	...
    	OPbuttons[7] = new Icon(7, "M�dio", new Point(Game.getScreen().getSize().x / 2 + 0, Game.getScreen().getSize().y / 4), null, null, null) ;
    	...
    	OPbuttons[13] = new Icon(13, "Ladr�o", new Point(Game.getScreen().getSize().x / 2 + 200, Game.getScreen().getSize().y / 4), null, null, null) ;
