...
public class QuestWindow extends GameWindow
{
	...
	{		
		...
		if (reqCreatureTypes != null)
		{
			...
			DP.DrawText(creaturesSectionPos, Align.center, angle, "Criaturas necessárias", font, textColor) ;
			DP.DrawLine(UtilG.Translate(creaturesSectionPos, -60, 20), UtilG.Translate(creaturesSectionPos, 60, 20), 1, textColor) ;
		...
		DP.DrawText(itemsSectionPos, Align.center, angle, "Itens necessários", font, textColor) ;
		DP.DrawLine(UtilG.Translate(itemsSectionPos, -60, 20), UtilG.Translate(itemsSectionPos, 60, 20), 1, textColor) ;
