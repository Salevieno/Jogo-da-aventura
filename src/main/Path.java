...
public class Path
{
    ...
    public static String CREATURES_IMG = "LiveBeings/Creatures/" ;
    public static String PET_IMG = "LiveBeings/Pet/" ;
    public static String PLAYER_IMG = "LiveBeings/Player/" ;
    ...
    static
    {
        try (FileInputStream fis = new FileInputStream("paths.properties"))
        {
            ...
            CREATURES_IMG = props.getProperty("CREATURES_IMG", CREATURES_IMG) ;
