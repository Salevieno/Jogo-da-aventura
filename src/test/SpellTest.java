...
//		List.of(knightLevel0, mageLevel0, archerLevel0, animalLevel0, thiefLevel0).forEach(Player::InitializeSpells) ;
	...
	void resetAttributes()
	{
		...
		knightLevel0.setBA(new BattleAttributes(Player.InitialAtts.get(1), 1, Player.InitialAtts.get(1)[41], Player.InitialAtts.get(1)[42])) ;
		mageLevel0.setBA(new BattleAttributes(Player.InitialAtts.get(2), 1, Player.InitialAtts.get(2)[41], Player.InitialAtts.get(2)[42])) ;
		archerLevel0.setBA(new BattleAttributes(Player.InitialAtts.get(3), 1, Player.InitialAtts.get(3)[41], Player.InitialAtts.get(3)[42])) ;
		animalLevel0.setBA(new BattleAttributes(Player.InitialAtts.get(4), 1, Player.InitialAtts.get(4)[41], Player.InitialAtts.get(4)[42])) ;
		thiefLevel0.setBA(new BattleAttributes(Player.InitialAtts.get(5), 1, Player.InitialAtts.get(5)[41], Player.InitialAtts.get(5)[42])) ;
		pet.setPA(Pet.InitializePersonalAttributes(pet.getJob())) ;
		pet.setBA(new BattleAttributes(Pet.InitialAtts.get(pet.getJob()), 1, Player.InitialAtts.get(pet.getJob())[36], Player.InitialAtts.get(pet.getJob())[37])) ;
