...
//		List.of(knightLevel0, mageLevel0, archerLevel0, animalLevel0, thiefLevel0).forEach(Player::InitializeSpells) ;
	...
	void resetAttributes()
	{
		...
		knightLevel0.setBA(new BattleAttributes(Player.initialAttributes.get(1), 1, Player.initialAttributes.get(1)[41], Player.initialAttributes.get(1)[42])) ;
		mageLevel0.setBA(new BattleAttributes(Player.initialAttributes.get(2), 1, Player.initialAttributes.get(2)[41], Player.initialAttributes.get(2)[42])) ;
		archerLevel0.setBA(new BattleAttributes(Player.initialAttributes.get(3), 1, Player.initialAttributes.get(3)[41], Player.initialAttributes.get(3)[42])) ;
		animalLevel0.setBA(new BattleAttributes(Player.initialAttributes.get(4), 1, Player.initialAttributes.get(4)[41], Player.initialAttributes.get(4)[42])) ;
